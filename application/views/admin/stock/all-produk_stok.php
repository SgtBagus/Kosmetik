...
<div class="modal fade bd-example-modal-sm" tabindex="-1" stock="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <form id="upload-delete" action="<?= base_url('admin/stock/delete') ?>">
        <div class="modal-header">
...
<script type="text/javascript">
  function loadtable(status) {
    ...
    var t = $("#mytable").dataTable({
      ...
      serverSide: true,
      ajax: {
        "url": "<?= base_url('admin/stock/json?status=') ?>" + status,
        "type": "POST"
      },
      columns: [{
          "data": "idStok",
  ...
  function edit(id) {
    ...
    $("#load-form").load("<?= base_url('admin/stock/edit/') ?>" + id);
  }
  ...
  function create() {
    ...
    $("#load-form").load("<?= base_url('admin/stock/create/') ?>");
  }
